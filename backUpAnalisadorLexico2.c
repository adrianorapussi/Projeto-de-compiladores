...
/*
 * Função verifica é chamada no main e recebe como parâmetro uma palavra.
 * Esta função simula o funcionamento do automato, ou seja, faz a analise de
 * palavra recebida e verifica se esta palavra pode ser aceita, e se for,
 * qual será sua classificação
 */
char **MATRIXinit(int r, int c) {
    char **t = malloc(r * sizeof(char *));
    //t é ponteiro para ponteiro para inteiro (vetor de vetores = matriz)
    // e o r é o tamanho desse vetor
    char i, j;
    for (i = 0; i < r; i++) {
        //i = linha (mais uma alocação no vetor)
        // linha por linha vai criando as colunas
...
int verifica(char *str) {
    ...
    // Q0 - ESTADO INICIAL ONDE CADA LETRA DA PALAVRA É ANALISADA
    // E SE ACEITA, É DIRECIONADA PARA O ESTADO DA SUA RESPECTIVA CLASSE
    // PARA PROSSEGUIR COM A VALIDAÇÃO
    ...
    if (str[i] == 'a' || str[i] == 'd' || str[i] == 'g' || str[i] == 'h' || str[i] == 'j' || str[i] == 'k' ||
        str[i] == 'o' || str[i] == 'q' || str[i] == 'u' || str[i] == 'x' || str[i] == 'y' || str[i] == 'z' ||
        ...
        str[i] == 'T' || str[i] == 'U' || str[i] == 'V' || str[i] == 'W' || str[i] == 'X' || str[i] == 'Y' ||
        str[i] == 'Z') {
        goto q113;
    }
    ...
    if (i = tamanho) {
        ...
        return -1;
               ...
               str[i] == 'g' || str[i] == 'i' || str[i] == 'h' || str[i] == 'j' ||
               str[i] == 'k' || str[i] == 'l' || str[i] == 'm' || str[i] == 'n' || str[i] == 'o' || str[i] == 'p' ||
               str[i] == 'q' || str[i] == 'r' || str[i] == 's' || str[i] == 't' || str[i] == 'u' ||
               str[i] == 'v' || str[i] == 'x' || str[i] == 'w' || str[i] == 'y' || str[i] == 'z' ||
               str[i] == 'A' || str[i] == 'B' || str[i] == 'C' || str[i] == 'D' || str[i] == 'E' || str[i] == 'F' ||
               str[i] == 'G' || str[i] == 'H' || str[i] == 'I' || str[i] == 'J' || str[i] == 'K' ||
               str[i] == 'L' || str[i] == 'M' || str[i] == 'N' || str[i] == 'O' || str[i] == 'P' || str[i] == 'Q' ||
               str[i] == 'R' || str[i] == 'S' || str[i] == 'T' || str[i] == 'U' || str[i] == 'V' ||
